...
class ObjectClassifier:
    def __init__(self, shape_class_path: str, ext_color_path: str, int_color_path: str, char_path:str, imgsz: int = 320):
        self.models = {
    ...
    def classify(self, cropped_object):
        ...
        classification_text = f"{predictions['shape']}, {predictions['ext-color']}, {predictions['int-color']}, {predictions['char']}"
...
char_path = classification.get('char_path')
classification_imgsz = classification.get('imgsz')


detector = ObjectDetector(model_detect_path, imgsz=detection_imgsz)
classifier = ObjectClassifier(shape_class_path, ext_color_path, int_color_path, char_path, imgsz=classification_imgsz)
